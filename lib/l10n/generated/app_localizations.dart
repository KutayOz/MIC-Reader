...
abstract class AppLocalizations {
  ...
  /// No description provided for @rotatePhoneHint.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @alignPlateHint.
  ///
  /// In en, this message translates to:
  /// **'Fit the plate in the frame'**
  String get alignPlateHint;
  ...
  /// No description provided for @analysisSavedAuto.
  ///
  /// In en, this message translates to:
  /// **'Analysis saved automatically'**
  String get analysisSavedAuto;
  ...
  /// No description provided for @editPatientName.
  ///
  /// In en, this message translates to:
  /// **'Edit Patient Name'**
  String get editPatientName;
}
